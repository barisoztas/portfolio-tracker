...
`portfolio-tracker` documentation uses [Sphinx] as its main documentation compiler.
...
[repository]: https://github.com/<USERNAME>/portfolio-tracker
[issue tracker]: https://github.com/<USERNAME>/portfolio-tracker/issues
